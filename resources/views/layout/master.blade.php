...
<body class="hold-transition sidebar-mini">
    ...
    <script>
        ...
        let api;
        let categoryPageScript = false;
        let categoryCreatePageScript = false;
        let productCreatePageScript = false;
        let productPageScript = false;
        let itemPageScript = false;
        let itemCreatePageScript = false;
        let propertyPageScript = false;
        let propertyCreatePageScript = false;
        let participationPageScript = false;
    </script>
